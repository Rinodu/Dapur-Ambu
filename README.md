...
Form di `order.html` menyiapkan ringkasan pesanan untuk dikirim pelanggan lewat WhatsApp ke nomor Dapur Ambu. Pesanan Custom Cake diberi penanda khusus di awal pesan. Data tidak tersimpan otomatis di situs; formulir Google Apps Script lama tetap ditautkan sebagai alternatif. Jalankan `node test-order.mjs` untuk memeriksa penyusunan tautan WhatsApp.
